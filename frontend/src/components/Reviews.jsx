...
const testimonials = [
  {
    ...
    initial: 'S',
    color: 'bg-blue-500',
    content: 'NEXOR AI Technologies transformed our digital presence completely. The new platform is not only beautiful but incredibly fast. Our customer engagement has increased by 40% since the launch.',
    rating: 5
  },
  {
    id: 2,
  ...
  },
  {
    ...
    initial: 'E',
    color: 'bg-purple-500',
    content: 'Working with NEXOR AI Technologies was seamless. They took our vague requirements and turned them into a stunning, conversion-optimized website. Highly recommended for any serious business.',
    rating: 5
  }
];
