...
function Portfolio() {
  return (
    <section id="work" className="max-w-[100vw] overflow-hidden py-32 border-t border-border-subtle">
      ...
      <div className="flex overflow-x-auto gap-8 px-6 pb-20 pt-10 snap-x snap-mandatory hide-scrollbar items-center md:items-stretch">
        {/* Spacer for initial padding */}
        <div className="hidden md:block min-w-[5vw] shrink-0"></div>

        {projects.map((project, index) => (
          <div 
            key={project.id}
            className={`group relative w-[85vw] md:w-[45vw] lg:w-[35vw] snap-center shrink-0 transition-transform duration-500 hover:z-10 ${
