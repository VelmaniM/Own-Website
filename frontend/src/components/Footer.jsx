      ...
      <div className="footer-grid">
        <div className="footer-col">
          ...
          <div className="footer-social-container">
            ...
            <a href="https://www.instagram.com/iam__velmanikandan?igsh=MTlvdXEzNGY4enRjag%3D%3D&utm_source=qr" target="_blank" rel="noreferrer" className="footer-social-link" title="Instagram">
            ...
            <a href="https://www.linkedin.com/in/velmani-m/" target="_blank" rel="noreferrer" className="footer-social-link" title="LinkedIn">
            ...
            <a href="mailto:velmani215@gmail.com" target="_blank" rel="noreferrer" className="footer-social-link" title="Mail">
